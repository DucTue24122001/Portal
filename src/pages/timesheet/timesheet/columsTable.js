      ...
      return (
        <>
          <Text
            type={
              record.late === null ||
              record.Note.includes('Approved', 'Late/Early')
                ? ''
                : 'danger'
            }
          >
    ...
    render: (Ot, record) => {
      return (
        <>
          <Text
            type={
              record.Ot === null || record.Note.includes('Approved', 'OT')
                ? ''
                : 'danger'
            }
          >
          ...
          <Text
            type={
              record.Worktime === '00:00'
                ? ''
                : moment(record.Worktime, 'hh:mm').isBefore(
                  moment('08:00', 'hh:mm')
